  ...
  return {
    ...
    controller: ['$scope', '$filter', '$compile', '$timeout', 'orsSettingsFactory', 'orsObjectsFactory', 'orsRequestService', 'orsUtilsService', 'orsMapFactory', 'orsCookiesFactory', 'lists', 'mappings', 'orsNamespaces', 'ENV', ($scope, $filter, $compile, $timeout, orsSettingsFactory, orsObjectsFactory, orsRequestService, orsUtilsService, orsMapFactory, orsCookiesFactory, lists, mappings, orsNamespaces, ENV) => {
      ...
      $scope.switchRegions = () => {
        ...
        ENV.geocoding = orsNamespaces.disasterServicesRouting[$scope.disasterRegionVal].geocoding; //for address search requests
        ENV.routing = orsNamespaces.disasterServicesRouting[$scope.disasterRegionVal].routing; //for routing requests
        ENV.analyse = orsNamespaces.disasterServicesRouting[$scope.disasterRegionVal].isochrones; //for accessibility analysis requests
        console.log(ENV)
